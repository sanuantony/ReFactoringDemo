...
namespace TestBed
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (DoseContentExist(item, MainList))
                {
        ...
        private static bool DoseContentExist(string thisIsDataRow,List<string> YourDataTable)
        {
            foreach (var item in YourDataTable)

            {
                if (item.Equals(thisIsDataRow))
                return true;
            }
